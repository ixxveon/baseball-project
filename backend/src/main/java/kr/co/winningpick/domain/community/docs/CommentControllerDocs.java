...
public interface CommentControllerDocs {
    ...
    @Operation(summary = "댓글 목록 조회", description = "게시글에 달린 댓글을 페이지 단위로 조회합니다.")
    @ApiResponses({
    ...
    kr.co.winningpick.global.response.ApiResponse<ResponsePage<ResponseComment>> getComments(Long postId, Pageable pageable);
